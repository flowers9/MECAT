...
void partition_candidates_reorder(const std::string& input, idx_t batch_size, int num_files, idx_t num_reads, const std::vector<idx_t>& read_order, const std::vector<int>& align_counts);
